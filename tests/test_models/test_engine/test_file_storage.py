...
class StorageTest(unittest.TestCase):
    ...
    def test_all_with_arg(self):
        ...
        with self.assertRaises(TypeError):
            all_obj = models.storage.all(None)
    ...
    def test_FileStorage_new_values_exist_in_all(self):
        """check values of added elements by new() in the dictionary"""
        _basemodel = BaseModel()
        _amenity = Amenity()
        _city = City()
        _place = Place()
        ...
        self.assertIn(_basemodel, models.storage.all().values())
